...
export default function JewelryPage(): JSX.Element {
  ...
  const jewelryItems: JewelryItem[] = [
    { id: 37, title: "Whisper Chain Necklace", image: whisperChain, price: "₦265,000", link: "/jewelry/whisper-chain", type: "Necklace" },
    { id: 38, title: "Muse Gold Hoops", image: museHoops, price: "₦185,000", link: "/jewelry/muse-hoops", type: "Earrings" },
    { id: 39, title: "Squared-shaped Gold Ring", image: squarering, price: "₦215,000", link: "/jewelry/ivory-ring", type: "Ring" },
    { id: 40, title: "Ivory Statement Ring", image: RingImg, price: "₦215,000", link: "/jewelry/ivory-ring", type: "Ring" },
    { id: 41, title: "Aura Gold Watch", image: auraWatch, price: "₦495,000", link: "/jewelry/aura-watch", type: "Watch" },
    { id: 42, title: "Silk Wrap Bracelet", image: silkBracelet, price: "₦175,000", link: "/jewelry/silk-bracelet", type: "Bracelet" },
    { id: 43, title: "Golden Wedding Rings", image: weddingRing, price: "₦175,000", link: "/jewelry/wedding-ring", type: "Ring" },
    { id: 44, title: "Engagement Ring", image: engagementRing, price: "₦175,000", link: "/jewelry/engagement-ring", type: "Ring" },
    { id: 45, title: "Statement Ring", image: statementring, price: "₦175,000", link: "/jewelry/statement-ring", type: "Ring" },
    { id: 46, title: "White and Blue sapphire Wedding Ring", image: sapphirering, price: "₦175,000", link: "/jewelry/sapphire-ring", type: "Ring" },
    { id: 47, title: "Ring with Ruby and Aquamarine Accents", image: rubyring, price: "₦175,000", link: "/jewelry/ruby-ring", type: "Ring" },
    { id: 48, title: "Gold ring", image: goldring, price: "₦175,000", link: "/jewelry/gold-ring", type: "Ring" },
    { id: 49, title: "Perfect Stack ring", image: stackring, price: "₦175,000", link: "/jewelry/stack-ring", type: "Ring" },
    { id: 50, title: "Infinity Knot Necklace in 18K Gold Plated", image: knotnecklace, price: "₦265,000", link: "/jewelry/knot-necklace", type: "Necklace" },
    { id: 51, title: "Layered Chain Choker Necklace", image: layerednecklace, price: "₦265,000", link: "/jewelry/layered-choker", type: "Necklace" },
    { id: 52, title: "Heart Pendant OT Buckle Necklace", image: chainnecklace, price: "₦265,000", link: "/jewelry/heart-pendant", type: "Necklace" },
    { id: 53, title: "Gold-Plated Stainless Steel", image: gold_plated, price: "₦265,000", link: "/jewelry/gold-plated", type: "Necklace" },
    { id: 54, title: "Heart Decor Necklace", image: heartdecor, price: "₦265,000", link: "/jewelry/heart-decor", type: "Necklace" },
    { id: 55, title: "Single Pearl Solitaire Necklace Choker", image: silvernecklace, price: "₦265,000", link: "/jewelry/pearl-choker", type: "Necklace" },
    { id: 56, title: "Pearl Necklace", image: pearl, price: "₦265,000", link: "/jewelry/pearl-necklace", type: "Necklace" },
    { id: 57, title: "Silver Pearl Layered Necklace", image: layeredpearl, price: "₦265,000", link: "/jewelry/layered-pearl", type: "Necklace" },
    { id: 58, title: "Butterfly pearl Bracelet", image: butterflybracelet, price: "₦175,000", link: "/jewelry/butterfly-bracelet", type: "Bracelet" },
    { id: 59, title: "Nordstrom Set of 2 Mesh Stretch Bracelets", image: setbracelet, price: "₦175,000", link: "/jewelry/set-bracelet", type: "Bracelet" },
    { id: 60, title: "Perfect Gold Set of Bracelets", image: goldset, price: "₦175,000", link: "/jewelry/goldset-bracelet", type: "Bracelet" },
    { id: 61, title: "Sterling Silver Personalized Bridesmaid Bracelet", image: silverbracelet, price: "₦175,000", link: "/jewelry/personalized-bracelet", type: "Bracelet" },
    { id: 62, title: "French Vintage Pearl Bracelet", image: vintage, price: "₦175,000", link: "/jewelry/vintage-bracelet", type: "Bracelet" },
    { id: 63, title: "Triple Tier Pearl Bracelet", image: pearlbracelet, price: "₦175,000", link: "/jewelry/pearl-bracelet", type: "Bracelet" },
    { id: 64, title: "Diamond Bracelet", image: diamond, price: "₦175,000", link: "/jewelry/diamond-bracelet", type: "Bracelet" },
    { id: 65, title: "Diamond Gold Bracelet", image: diamondgold, price: "₦175,000", link: "/jewelry/diamond-gold-bracelet", type: "Bracelet" },
    { id: 66, title: "Round Pointer Quartz Watch", image: quartzwatch, price: "₦495,000", link: "/jewelry/quartz-watch", type: "Watch" },
    { id: 67, title: "Gold chain watch", image: goldwatch, price: "₦495,000", link: "/jewelry/gold-watch", type: "Watch" },
    { id: 68, title: "Meibo Quartz Analog Stainless Steel Wristwatch.", image: bronzewatch, price: "₦495,000", link: "/jewelry/meibo-watch", type: "Watch" },
    { id: 69, title: "Squared Leather Watch", image: squarewatch, price: "₦495,000", link: "/jewelry/squared-watch", type: "Watch" },
    { id: 70, title: "Fossil Gold Watch", image: fossilwatch, price: "₦495,000", link: "/jewelry/fossil-watch", type: "Watch" },
    { id: 71, title: "Rhinestone Decor Round Pointer Date Quartz Watch", image: rhinewatch, price: "₦495,000", link: "/jewelry/rhine-watch", type: "Watch" },
    { id: 72, title: "Minimalist stainless steel dress watch", image: darkwatch, price: "₦495,000", link: "/jewelry/dark-watch", type: "Watch" },
    { id: 73, title: "Modern Rado Watch for Young Men", image: radowatch, price: "₦495,000", link: "/jewelry/rado-watch", type: "Watch" },
    { id: 74, title: "Triple Knot Earrings - Gold", image: tripleearing, price: "₦495,000", link: "/jewelry/triple-knot-earrings", type: "Earrings" },
    { id: 75, title: "Pearl Dropping Earing", image: pearlearing, price: "₦495,000", link: "/jewelry/pearl-earrings", type: "Earrings" },
    { id: 76, title: "Emerald Dropping Earing", image: emeraldearing, price: "₦495,000", link: "/jewelry/emerald-earrings", type: "Earrings" },
    { id: 77, title: "Floret Blue Sapphire Round & Diamond Stud Earrings", image: studearing, price: "₦495,000", link: "/jewelry/floret-studs", type: "Earrings" },
    { id: 78, title: "Diamond Halo Stud Earrings", image: diamondstud, price: "₦495,000", link: "/jewelry/diamond-studs", type: "Earrings" },
    { id: 79, title: "Diamond Pearl Dropping Earring", image: diamondpearl, price: "₦495,000", link: "/jewelry/diamond-pearl-earrings", type: "Earrings" },
    { id: 80, title: "Gold Hoop Earring", image: hoopearing, price: "₦495,000", link: "/jewelry/gold-hoops", type: "Earrings" },
    { id: 81, title: "Thick Gold Hoop Earring", image: thickhoopearing, price: "₦495,000", link: "/jewelry/thick-hoops", type: "Earrings" },
  ];
